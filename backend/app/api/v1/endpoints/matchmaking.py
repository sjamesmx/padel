...
async def rate_opponents(
    match_id: str,
    ratings: Dict[str, int] = Query(..., description="Diccionario de calificaciones por jugador (1-5)"),
    comments: Optional[Dict[str, str]] = Query(None, description="Comentarios opcionales por jugador"),
    current_user: UserInDB = Depends(get_current_user)
):
    """
